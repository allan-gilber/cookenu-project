...
import app from './controller/appLogic/AppLogic';
...
app.put('/user/password-recover/resetpassword/:hashToken', (req: Request, resp: Response) => new UserController().newUserPassword(req, resp));
